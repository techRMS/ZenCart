...
class cardstream_lib
{
    ...
    function draw_direct_form(){
        ...
        $selection = array('id' => 'cardstream',
            'module' => $this->module_title(),
            'fields' => array(array('title' => MODULE_PAYMENT_CARDSTREAM_CARD_HOLDER,
                ...
                array('title' => MODULE_PAYMENT_CARDSTREAM_CARD_CVV,
